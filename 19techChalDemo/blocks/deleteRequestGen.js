Blockly.PHP['deleteRequest'] = function(block) {
...
//   return fileAndCode;
  ...
  var methodCheckStart = 'if ($_SERVER["REQUEST_METHOD"] == "DELETE") {\n'
  var methodCheckEnd = '} else {\n'+value_return_status+'=405;\n'+Blockly.PHP.valueToCode(block, 'RETURN_BODY')+'="Set http method to DELETE";\n}\n'
